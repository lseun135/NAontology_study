...
# ====== 본회의 고정값 ======
COMMITTEE_CODE: str      = "PLEN"
COMMITTEE_LABEL_KO: str  = "국회본회의"
BRANCH: str              = "PLEN"
COMMITTEE_IRI: str       = "https://lseun135.github.io/NAontology_study/resource/d2-person#NationalAssembly"

# ====== 경로/입력 ======
CSV_PATH       = r"D:/연구/국회회의록/21대_본회의_new_1.csv"         # 본회의 CSV
OUT_TTL        = r"D:/연구/국회회의록/251105_SC/d1-record_PLEN.ttl"  # 출력 TTL(d1)
PEOPLE_TTL     = r"https://lseun135.github.io/NAontology_study/resource/d2-person.ttl"
OUT_TMP_PEOPLE = r"D:/연구/국회회의록/251105_SC/tmp_person_PLEN.ttl" # 임시 Person TTL
...
def convert(csv_path, out_path, tmp_people_out_path,
    ...
    member_total = 0                # 의원ID가 비어있지 않은 행 수
    member_match_by_code = 0        # / PER-.. 식별자로 d2 매칭 성공
    member_match_by_name = 0        # 이름 인덱스로 d2 매칭 성공
    member_prov_rows = 0            # d2 매칭 실패 → 임시개체로 떨어진 행 수
